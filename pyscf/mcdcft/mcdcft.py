...
class DCFT_base(lib.StreamObject):
    def __init__(self, mol, dc, hyb_x=0., display_name=None, grids_level=None):
        self.dcfnal = dcfnal(mol, dc, hyb_x, display_name, grids_level)
    ...
    def recalculate_with_xc(self, dc, display_name=None, hyb_x=0., chkdata=None,
        ...
        ''' Recalculate MC-DCFT total energy based on intermediate quantities from a previous MC-DCFT calculation
            ...
            Args:
                ...
                display_name : display name of the functional. If None, use dc as the display name
                chkdata : chkdata dict generated by previous calculation
        ...
        if isinstance(dc, str):
            ...
            self.dcfnal = dcfnal(self.mol, dc, hyb_x, display_name, grids_level, self.verbose)
        else:
            self.dcfnal = dc
...
def CASSCFDCFT(mf_or_mol, dc, ncas, nelecas, display_name=None, grids_level=None, hyb_x=0.,
    ...
    mc = get_mcdcft_child_class(mc, dc, ncas, nelecas, display_name=display_name,
                                grids_level=grids_level, hyb_x=hyb_x, **kwargs)
    mc.chkfile = chkfile
    return mc
