...
def setUpModule():
    ...
    cell_h2.a = numpy.array([[6.0, 0.0, 0.0],
                             [0.0, 6.0, 0.0],
                             [0.0, 0.0, 6.0]])
    ...
    kpts_2x2x2 =  cell_diamond.make_kpts([2, 2, 2],
...
class TestPivotSelection(unittest.TestCase):
    ...
    def test_get_pivots_execution(self):
        ...
        self.assertTrue(numpy.array_equal(self.mydf.pivots, numpy.sort(self.mydf.pivots)))
...
class TestExchangeMatrixEvaluation(unittest.TestCase):
    ...
    def test_exchange_matrix_computation(self):
        ...
        _, vk = self.mf.get_jk(dm=self.dm, with_j=False, with_k=True, kpts=self.mydf.kpts)
    ...
    def test_exchange_matrix_hermiticity(self):
        ...
        _, vk = self.mydf.get_jk(dm=self.dm, with_j=False, with_k=True, kpts=numpy.zeros(3))
