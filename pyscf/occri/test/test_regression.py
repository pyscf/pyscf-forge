...
class TestRegression(unittest.TestCase):
    ...
    def test_rhf_regression(self):
        ...
        self.assertLess(en_diff, TOL, f"RHF energy difference {en_diff} exceeds tolerance {TOL}")
    ...
    def test_uhf_regression(self):
        ...
        en_diff = abs(en - en_fftdf) / self.cell.natm
        self.assertLess(en_diff, TOL, f"UHF energy difference {en_diff} exceeds tolerance {TOL}")
    ...
    def test_rks_pbe0_regression(self):
        ...
        en_diff = abs(en - en_fftdf) / self.cell.natm
        self.assertLess(en_diff, TOL, f"RKS energy difference {en_diff} exceeds tolerance {TOL}")
    ...
    def test_uks_pbe0_regression(self):
        ...
        en_diff = abs(en - en_fftdf) / self.cell.natm
        self.assertLess(en_diff, TOL, f"UKS energy difference {en_diff} exceeds tolerance {TOL}")
    ...
    def test_convergence_properties(self):
        ...
        self.assertLess(e_exchange, -1.0, "Exchange energy should be significant and negative")
