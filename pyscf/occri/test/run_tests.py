...
def main():
    ...
    if args.quick:
        ...
        try:
            from test_isdfx import (TestCholeskyDecomposition,
                                    TestExchangeMatrixEvaluation,
                                    TestFittingFunctions, TestISDFX,
                                    TestISdfxIntegration, TestPivotSelection,
                                    TestTHCPotential, TestUtilityFunctions)
