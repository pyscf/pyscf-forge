...
from pyscf.occri import OCCRI, _OCCRI_C_AVAILABLE
...
class TestPerformance(unittest.TestCase):
    ...
    def test_c_vs_python_performance(self):
        ...
        self.assertGreater(speedup, 0.5, "C implementation significantly slower than Python")
    ...
    def test_memory_scaling(self):
        ...
        self.assertLess(actual_scaling, expected_scaling * 3, 
    ...
    def test_convergence_stability(self):
        ...
        self.assertLess(e_std, 1e-8, "SCF convergence not stable across initializations")
