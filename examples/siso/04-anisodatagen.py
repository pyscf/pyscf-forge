...
Dy 0 0 0
O 0 0 1.74'''
mol.basis= {'Dy': 'ano@6s5p3d1f', 'O': 'ano@2s1p'} # ANO-MB
mol.spin = 5
mol.charge = 1
mol.verbose = 4
...
# Note this is just for demonstration purposes. Use appropirate number of states for production level computations.
modelspace = [(3,6),]
...
# the aniso data file created above (DyO.aniso) and binaries of the single_aniso module. Currently you can access
