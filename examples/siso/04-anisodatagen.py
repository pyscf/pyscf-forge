...
# 7. To run the single_aniso module, you will need to create its input file in
# addition to the aniso data file created above (DyO.aniso) and the binaries of
# the single_aniso module. Currently you can access these via
# OpenMolcas or Orca.
